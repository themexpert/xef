 ...
 */
 ...
 jQuery(document).ready(function(fn){
     ...
     function showJoomla()
     {
         ...
         fn('[aria-controls="attrib-JOOMLA"]').closest('button').show();
         fn('[aria-controls="attrib-K2"]').closest('button').hide();
         fn('[aria-controls="attrib-FLICKR_SETTINGS"]').closest('button').hide();
     ...
     function showK2()
     {
         ...
         fn('a[href="#options-MODULE"]').closest('li').hide();
          ...
          //j4 fix 
          fn('[aria-controls="attrib-JOOMLA"]').closest('button').hide();
          fn('[aria-controls="attrib-K2"]').closest('button').show();
          fn('[aria-controls="attrib-FLICKR_SETTINGS"]').closest('button').hide();
     ...
     function showFlickr()
     {
         ...
         fn('a[href="#options-MODULE"]').closest('li').hide();
          ...
          fn('[aria-controls="attrib-JOOMLA"]').closest('button').hide();
          fn('[aria-controls="attrib-K2"]').closest('button').hide();
          fn('[aria-controls="attrib-FLICKR_SETTINGS"]').closest('button').show();
     ...
     fn('#source_selector').on('click', function(){
